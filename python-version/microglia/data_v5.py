...
def data0():
    ...
    y0 = [Cai, CaF, CaS, CaER,
          ...
          DNA, DNA_TNF, mRNA, TNFa, TNFa_leak, TNFa_release, TNFa_release_total, maxflux, time]
...
def data(y0,y,t):
    ...
    NFATpc, NFATpn, NFATNc, NFATNn,
    DNA, DNA_TNF, mRNA,
    TNFa, TNFa_leak, TNFa_release, TNFa_release_total, maxflux, time] = y0
    ...
    maxflux = np.append(maxflux,y[:,44])
