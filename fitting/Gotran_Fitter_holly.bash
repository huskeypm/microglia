...
cd /home/bch265/microglia/bens-code/Gotran/ben-gotran/fitting
...
for (( i=1; i<=$finalstep; i++))
  do
    ...
    for name in k2_ptxf k4_ptxf k6_ptxf k1_ptxf k3_ptxf k5_ptxf H1_ptxf H2_ptxf H3_ptxf H4_ptxf
      do
        python fittingAlgorithm.py -odeModel p2x4_MG_single.ode -myVariedParam $name -variedParamTruthVal ${array[$j]} -jobDuration $duration -fileName This_Is_A_Test.png -numRandomDraws 10 -numIters $iters -sigmaScaleRate $sigma -outputParamName I_ptxf -outputParamSearcher I_ptxf -outputParamMethod pro -outputParamTruthVal 0 >& log.txt
