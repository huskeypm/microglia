...
#  python daisychain.py -dt 0.1 -dSr 1000 -jit -odeName $ODEFILEshort -T 3600000 -iters 1 -var stim_period 80e3 -var stim_space 80e3 -var stim_amplitude 1000 -name ./20st80rsMG_1mMATPnew 
  python daisychain.py -dt 0.1 -dSr 1000 -jit -odeName $ODEFILEshort -T 3600000 -iters 1 -var stim_period 80e3 -var stim_space 120e3 -var stim_amplitude 1000 -name ./20st120rsMG_1mMATPnew 
#  python daisychain.py -dt 0.1 -dSr 1000 -jit -odeName $ODEFILEshort -T 3600000 -iters 1 -var stim_period 80e3 -var stim_space 160e3 -var stim_amplitude 1000 -name ./20st160rsMG_1mMATPnew 
